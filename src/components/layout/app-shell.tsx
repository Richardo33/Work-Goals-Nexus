  ...
  return (
    <div className="min-h-screen bg-transparent">
      <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-8 px-4 py-6 sm:px-6 lg:px-8">
        <header className="rounded-4xl border border-white/60 bg-white/80 px-6 py-5 shadow-[0_24px_60px_-40px_rgba(15,23,42,0.45)] backdrop-blur">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="space-y-2">
              ...
              >
                <span className="flex h-12 w-37.5 items-center justify-start overflow-hidden">
                  <Image
                    src="/logo.png"
                    alt="WGN logo"
                    width={150}
